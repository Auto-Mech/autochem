...
from automol.zmatrix._util import rct1_x_join
from automol.zmatrix._util import rct1x_rct2_join
...
def insertion(rct_zmas, prd_zmas, tras):
    ...
    tra = tras[0]
    frm_bnd_keys, _ = trans_old.formed_bond_keys(tra)
...
def addition(rct_zmas, prd_zmas, tras):
    ...
    tra = tras[0]
    frm_bnd_keyss, = trans_old.formed_bond_keys(tra)
...
def _sigma_hydrogen_abstraction(rct_zmas, prd_zmas):
    ...
    if rxn_idxs is not None:
        ...
        if tras:
            ...
            insert_val_dct = {
                'rx2': 1. * phycon.ANG2BOHR,
                'ax2': 90. * phycon.DEG2RAD,
                'dx2': 180. * phycon.DEG2RAD
            }
