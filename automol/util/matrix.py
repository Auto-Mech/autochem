...
def axis_alignment_matrix(xyz1, xyz2):
    ...
    mat = numpy.zeros((3, 3))
    mat[0] = vector.unit_norm(xyz1)
    mat[2] = vector.unit_perpendicular(xyz1, xyz2)
...
def superimposition_matrix(points1, points2, keep_origin=False):
    ...
    if keep_origin:
        points1 = numpy.concatenate(([[0.0, 0.0, 0.0]], points1), axis=0)
        points2 = numpy.concatenate(([[0.0, 0.0, 0.0]], points2), axis=0)
