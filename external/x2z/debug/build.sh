...
cmake $PROJECT_ROOT -DCMAKE_INSTALL_PREFIX=$THIS_DIR -DPYTHON_INSTALL_PATH=$THIS_DIR/lib -DCMAKE_C_COMPILER=$CC -DCMAKE_CXX_COMPILER=$CXX -DCMAKE_CXX_FLAGS="${DEBUG_CXXFLAGS}" -DCMAKE_C_FLAGS="${DEBUG_CFLAGS}"
make VERBOSE=1
make install
