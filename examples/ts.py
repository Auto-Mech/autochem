...
# 2. Generate reactant and product graphs
...
# 3. Classify the reaction and get the bonds broken and formed
...
# 4. Generate a reactant graph and a sorted list of atom keys
